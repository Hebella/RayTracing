...
private:
    ...
    static void permute(int * p, int n) // shuffle elements in p
    {
...
public:
    ...
    double noise(const point3 & p) const
    {
        ...
        vec3 c[2][2][2]; // floor and ceiling
    ...
    double turb(const point3 & p, int depth = 7) const // a sum of repeated calls to noise
    {
        auto accum = 0.0;
        auto temp_p = p;
        auto weight = 1.0;
